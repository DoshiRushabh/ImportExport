...
public class MainFragment extends Fragment {
    ...
    private void initializeDummyData() {
        ...
        topicList.add(new topic(R.drawable.importdocument,"Import Document","This section provide information about important documentation, registration of importers, identification of supplier, important aspects of import contract & payment formalities."));
        }
