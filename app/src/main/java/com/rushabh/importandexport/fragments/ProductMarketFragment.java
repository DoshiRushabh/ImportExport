...
public class ProductMarketFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.Link1){
            ...
            bundle.putString("title","Trade Promotional Bodies");
            ...
            bundle.putString("url","International Resources");
            bundle.putString("title","www.irgnet.org/resources.php");
        }else if (view.getId() == R.id.Link33){
            bundle.putString("url","http://stat.wto.org/CountryProfile/WSDBCountryPFHome.aspx?Language=E");
            bundle.putString("title","Export Import Statistics");
